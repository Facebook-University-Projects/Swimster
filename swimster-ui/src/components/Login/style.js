export const style = {
    ...
    userDetails: 'flex flex-col w-11/12 space-y-4',
    inputElement: 'rounded-md p-3 bg-gray-200 w-full',
    submitButton: 'bg-indigo-500 w-full py-2 rounded-lg place-self-center text-white cursor-pointer',
    toLogin: 'text-sm',
